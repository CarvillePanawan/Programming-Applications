...
public class AllCodes {
    ...
    /**
	 *Algorithm:
	 *1.Declare long minimum, that will be used to store the lowest number possible
	 *2.Declare int index taht will hold the index of the lowest number in n
	 *3.Declare int moveToIndex, that will hold the index where you move the lowest number in n
	 *4.Declare String number that will hold the String form of n
	 *5.for int i = 0; i is less than length of number; increment i
	 *5.1.for int j=0; j is less than length of numberl increment j
	 *5.1.1.if i is not equal to j making(number, i, j) is less than minimum
	 *5.1.1.1. assign making(number, i, j) to minimum
	 *5.1.1.2. assign i to index
	 *5.1.1.3. assign j to moveToIndex
	 *6. return new long[]{minimum, index, moveToIndex}
	...
	/**
	 *Algorithm:
	 *1. Let sb be a StringBuilder and instantiate it
	 *2. Let c be a char that will hold the character at given index of sb
	 *3. delete the character of sb at given index 
	 *4. insert c in sb at given moeToIndex
	 *5. Return Long.valueOf(sb.toString()
     ...
     *@return sum the sum of digital roots.
     */
     ...
     *  2. Declare a boolean variable and set it to true
	 *	3. Construct nested loops for the row and column of the two dimensional array
	 *  4. If there is an equal value in one row or a value that is equal to 0, set the variable to false
	 ...
	 *2. if N is less than 9 , return the value of n
    ...
    */
	 ...
	 *3.long i = start; i less than or equal end; i++
	 *3.1. if i is prime
	...
	public static String backwardsPrime(long start, long end) {
  	 ...
  	 *1.1. return false
  	 *		else
  	 *2.for(int i = 3; i*i less than or equal number; i+=2)
